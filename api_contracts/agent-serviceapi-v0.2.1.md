...
- **Name (`confirm_name`):** completion is based on `public.users.user_first_name` (set by the client app at signup and/or by this service when the user answers “how to address you”).
